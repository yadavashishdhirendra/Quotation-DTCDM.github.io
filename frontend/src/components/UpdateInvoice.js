                                            ...
                                            return (
                                                <div className='project-Inputs' key={index}>
                                                    <div>
                                                        ...
                                                        <input className='mb-3' value={product.itemname} name="itemname" onChange={(e) => onchange(e, index)} type="text" placeholder='Product Name' />
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div>
                                                        <select className='mb-3' name='pricesign' value={product.pricesign} onChange={(e) => onchange(e, index)} required>
